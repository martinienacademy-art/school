    ...
    try {
        ...
        if (students.length > 0) {
            ...
            const studentData = uniqueStudents.map(s => ({
                ...
                matricule_national: s.matriculeNational || null,
                ...
                numero_acte_naissance: s.numeroActeNaissance || null,
                recu: s.recu || null,
                adsn: s.adsn || null,
                photo_url: s.photoUrl || null,
                nationalite: s.nationalite || 'Béninoise',
                adresse: s.adresse || '',
    ...
    try {
        ...
        students.forEach(s => {
            studentMap.set(s.id, {
                ...
                lieuNaissance: s.lieu_naissance || null,
                numeroActeNaissance: s.numero_acte_naissance || null,
                matriculeNational: s.matricule_national || null,
                adsn: s.adsn || null,
